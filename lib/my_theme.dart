...
class MyTheme {
  ...
  static Color accent_color = Color(0xffe20145);
  static Color appColor = Color(0xffe20145);
  static Color blue_color = Color(0xff0457D6);
  static Color accent_color_shadow =
      Color.fromRGBO(229, 65, 28, .40); // this color is a dropshadow of
  static Color soft_accent_color = Color(0xffFFD8C7);
  ...
  static Color amber = Color(0xffFFD8C7);
